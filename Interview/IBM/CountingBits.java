/*
    Counting Bits Problem (Mock Interview)

    Get the number of 1 bits in the bit conversion of given number
    And also return the position of the 1 bits in the bit array
